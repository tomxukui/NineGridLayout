...
public class DraweeNineGridLayout extends NineGridLayout<SimpleDraweeView> {
    ...
    public DraweeNineGridLayout(Context context) {
        super(context);
        mContext = context;
    }

    public DraweeNineGridLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    }

    public DraweeNineGridLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mContext = context;
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public DraweeNineGridLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
